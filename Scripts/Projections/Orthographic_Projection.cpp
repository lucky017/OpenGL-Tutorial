...
int main()
{
   ...
   gladLoadGL();  
   Shader shader("Projections/Orthographic_Projection.vs","Projections/Orthographic_Projection.fs");
   ...
   while(!glfwWindowShouldClose(window))
   {
      ...
      //glm::mat4 projection = glm::perspective(glm::radians(55.0f), WIDTH / HEIGHT, 0.1f, 100.0f);
      ...
      glUniformMatrix4fv(Location, 1, GL_FALSE, glm::value_ptr(ortho));
      
      for(GLuint i=0; i<10; i++)
      {
         glm::mat4 model = glm::mat4(1.0f);
         model = glm::translate(model, cubePositions[i]); 
         model = glm::rotate(model, (GLfloat)glfwGetTime() * glm::radians(40.0f), glm::vec3(0.5f, -0.5f, 0.5f)); 
