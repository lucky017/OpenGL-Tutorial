...
int main()
{
   ...
   Shader shader("Textures/Texture.vs", "Textures/Texture.fs");
   ...
   unsigned char* data = stbi_load("/home/lucky/opengl/Resources/Textures/container.jpg", &width, &height, &nrChannels, 0);
   if(data)
   {
