...
int main()
{
   ...
   unsigned char* data1 = stbi_load("/home/lucky/opengl/src/Resources/Textures/wall.jpg", &width, &height, &nrChannels, 0);
   if(data1)
   {
   ...
   glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    ...
    unsigned char* data2 = stbi_load("/home/lucky/Downloads/Maul-Anakin.png", &width, &height, &nrChannels, 0);
   if(data2){
